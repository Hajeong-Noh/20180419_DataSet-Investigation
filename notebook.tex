...
team's standing in the league has changed through out his career.
\end{quote}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{\PYZsh{} Import necessary packages}
...
\subsubsection{Data Gathering}\label{data-gathering}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} Connect to the database and load all the tables on the python code}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} 1\PYZhy{}1. Very large columns on match table}
        \PY{n}{match}\PY{o}{.}\PY{n}{shape}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:} (25979, 115)
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} 1\PYZhy{}2. Lots of null values in match table}
        \PY{n}{match}\PY{o}{.}\PY{n}{isnull}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} id                      0
        country\_id              0
        league\_id               0
        season                  0
        stage                   0
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} 2. The data type of \PYZsq{}date\PYZsq{} in match, team\PYZus{}attribute and player\PYZus{}attribute table is object, not datetime.}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}5}]:} (dtype('O'), dtype('O'), dtype('O'))
\end{Verbatim}
            
    \subsubsection{Data Cleaning}\label{data-cleaning}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} 1. Make new dataframe that does not contain columns that are not used in this notebook for analysis}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:}    id  country\_id  league\_id     season  stage                 date  \textbackslash{}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} 2. change data type of \PYZsq{}date\PYZsq{} column to datetime}
        ...
        \PY{n}{match\PYZus{}simple}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{dtypes}\PY{p}{,} \PY{n}{ta}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{dtypes}\PY{p}{,} \PY{n}{pa}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{dtypes}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} (dtype('<M8[ns]'), dtype('<M8[ns]'), dtype('<M8[ns]'))
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} 3. From which month to which month means season 2012/2013?}
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} 4. Append \PYZsq{}season\PYZsq{} column in team attributes and player attributes so that it is easier to compare them with match table}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} ('2008/2009', '2009/2010')
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} 4\PYZhy{}2. Append \PYZsq{}season\PYZsq{} column in team attributes and player attributes}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} 5. Merge player and player\PYZus{}attribute table for the better analysis}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} (183978, 49)
\end{Verbatim}
...
career?}\label{q1.-which-player-showed-the-most-improved-performance-throughout-his-career}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} A1\PYZhy{}1. Define a function to measure the difference of max overall average rating and min overall average rating of each player\PYZsq{}s career}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} 4.333333333333329
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} A1\PYZhy{}2. Get improved performance of all players and append it in player table}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}13}]:}    id  player\_api\_id         player\_name  player\_fifa\_api\_id  \textbackslash{}
         ...
         4   5          23780        Aaron Hughes               17725   
                       ...
                       birthday  height  weight    improve  
         0  1992-02-29 00:00:00  182.88     187   4.333333  
         1  1989-12-15 00:00:00  170.18     146  23.375000  
         2  1991-05-13 00:00:00  170.18     163  10.200000  
         3  1982-05-08 00:00:00  182.88     198   7.000000  
         4  1979-11-08 00:00:00  182.88     154   8.000000  
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} A1\PYZhy{}3. Sort by improve in descending order}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}14}]:}         id  player\_api\_id            player\_name  player\_fifa\_api\_id  \textbackslash{}
         ...
         8696  8710          41433       Radja Nainggolan              178518   
                          ...
                          birthday  height  weight    improve  
         6715  1989-05-31 00:00:00  180.34     165  42.000000  
         3460  1987-09-14 00:00:00  182.88     161  39.000000  
         2835  1991-01-07 00:00:00  172.72     163  37.666667  
         8915  1992-08-25 00:00:00  180.34     170  37.666667  
         8696  1988-05-04 00:00:00  175.26     143  37.000000  
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} A1\PYZhy{}4. Average improve of all European league players}
         \PY{n}{player}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{improve}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} 8.455834468828424
\end{Verbatim}
...
period?}\label{q2.-how-is-hes-rating-improved-throughout-his-career-how-has-his-teams-standing-in-the-league-changed-in-this-period}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} A2\PYZhy{}1. Get the season ratings of Marco Reus}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}16}]:} season
         2006/2007    44.000000
         2008/2009    53.500000
         2009/2010    71.000000
         2010/2011    76.500000
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} A2\PYZhy{}2. Fill the 2007/2008 season with the mean rating of 2006/2007 season and 2008/2009 season}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}17}]:} season
         2006/2007    44.000000
         2007/2008    48.750000
         2008/2009    53.500000
         2009/2010    71.000000
...
searched for Marco Leus' team information of each season in Wikipedia.
...
\begin{quote}
Marco Leus has played in Bundesliga for his whole career. Let's explore
how the standing of each team in Bundesliga has changed throughout the
years!
\end{quote}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}1. What is the ID of Bundesliga?}
         \PY{n}{league}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}18}]:}        id  country\_id                      name
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}2. Check the teams in Bundesliga}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}19}]:} array([], dtype=int64)
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}3. Check the seasons in Bundesliga}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} array(['2008/2009', '2009/2010', '2010/2011', '2011/2012', '2012/2013',
                '2013/2014', '2014/2015', '2015/2016'], dtype=object)
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{home\PYZus{}teams}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}21}]:} array([ 9823,  8178, 10189,  8721,  9810,  9912,  8398,  9788,  8295,
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}4. Make a Bundesliga standings table}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}22}]:}       season team\_id                 name win draw lose point
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}5. Fill the points in the standings table according to Bundesliga match records}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}23}]:}         season team\_id                      name win draw lose point
         ...
         12   2008/2009    8722                1. FC Köln  11    6   17    39
         4    2008/2009    9810       Eintracht Frankfurt   8    9   17    33
         13   2008/2009    9911                VfL Bochum   7   11   16    32
         7    2008/2009    9788  Borussia Mönchengladbach   8    7   19    31
         ...
         19   2008/2009    8165            1. FC Nürnberg   0    0    0     0
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}6. Rank each season by point}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}24}]:}        season team\_id               name win draw lose point  rank
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} A3\PYZhy{}7. How has the standings of the team where Marco Reus played in changed?}
         \PY{n}{bu\PYZus{}standings}\PY{o}{.}\PY{n}{query}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name == }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{Borussia Mönchengladbach}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}25}]:}         season team\_id                      name win draw lose point  rank
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{bu\PYZus{}standings}\PY{o}{.}\PY{n}{query}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name == }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{Borussia Dortmund}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}26}]:}         season team\_id               name win draw lose point  rank
...
career?}{How has the rating of Marco Reus changed in his career?}}\label{how-has-the-rating-of-marco-reus-changed-in-his-career}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{n}{team\PYZus{}color} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         ...
         \PY{n}{BM} \PY{o}{=} \PY{n}{mpatches}\PY{o}{.}\PY{n}{Patch}\PY{p}{(}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Borussia Mönchengladbach}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}64}]:} \PY{c+c1}{\PYZsh{} Add title and labels}
         ...
         \PY{c+c1}{\PYZsh{} Plot Borussia Mönchengladbach standings}
         \PY{n}{BM\PYZus{}standings} \PY{o}{=} \PY{n}{bu\PYZus{}standings}\PY{o}{.}\PY{n}{query}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name == }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{Borussia Mönchengladbach}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{quote}
While \texttt{Marco\ Reus} played in \emph{Borussia Mönchengladbach}
